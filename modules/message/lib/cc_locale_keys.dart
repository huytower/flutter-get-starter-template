...
static const Map<String,dynamic> _vi = {
  ...
  "reconciliation": {
    ...
    "undo_confirm": "Hoàn tác đợt đối soát gần nhất và xóa các bút toán điều chỉnh?",
    "week": "Tuần {week}/{year}",
    "book": "Sổ sách",
    "actual": "Thực tế",
  ...
  "report": {
    ...
    "runway_insufficient": "Hãy bắt đầu ghi chép chi tiêu để hệ thống tính toán chỉ số an toàn cho bạn.",
