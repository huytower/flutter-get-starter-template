...
class BudgetManagementPage extends CcGetView<BudgetController> {
    ...
    return Obx(() {
      ...
      return Builder(
        builder: (context) => CustomScrollView(
          slivers: [
            // Always present so _BudgetGrid stays at sliver-index 1 and its
  ...
  void _openForm(BuildContext context, {BudgetEntity? editTarget}) {
    showModalBottomSheet<void>(
      ...
      builder: (_) => BudgetFormSheet(editTarget: editTarget),
    );
  }
...
class _BudgetGrid extends StatefulWidget {
  final BudgetController controller;
  final void Function(BuildContext, {BudgetEntity? editTarget}) onOpenForm;
  final void Function(BuildContext, BudgetEntity) onDelete;
  ...
  @override
  State<_BudgetGrid> createState() => _BudgetGridState();
}

class _BudgetGridState extends State<_BudgetGrid> {
  ...
  BudgetController get _ctrl => widget.controller;

  @override
  void didUpdateWidget(_BudgetGrid old) {
  ...
  Widget _buildDraggableCell(BuildContext context, BudgetStatsEntity stats) {
    ...
    return LayoutBuilder(
      builder: (ctx, constraints) => LongPressDraggable<String>(
        ...
        feedback: Material(
          ...
          child: SizedBox(
            ...
            child: Transform.scale(
              scale: 1.08,
              child: BudgetGridCard(stats: stats, isDragging: true),
            ),
          ),
        ),
        ...
        childWhenDragging: Opacity(
          opacity: 0.25,
          child: BudgetGridCard(stats: stats),
        ),
        ...
        child: DragTarget<String>(
          ...
          builder: (ctx, candidates, _) => AnimatedScale(
            ...
            child: AnimatedOpacity(
              ...
              duration: const Duration(milliseconds: 150),
              child: BudgetGridCard(key: ValueKey(id), stats: stats),
            ),
          ),
        ),
      ),
  ...
  Widget _buildEditCell(BuildContext context, BudgetStatsEntity stats) {
