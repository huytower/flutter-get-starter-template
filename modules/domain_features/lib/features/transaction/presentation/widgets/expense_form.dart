...
class _ExpenseFormState extends State<ExpenseForm> {
    ...
    return Column(
      children: [
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const CategorySelectionSection(activeColor: Color(0xFFE54D42)),
                const CcSpaceLG(),
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                _buildLabel(
                                  el.tr(
                                    CcLocaleKeys.transaction_reason_expense,
                                  ),
                                ),
                                const CcSpaceXS(),
                                _buildTextField(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                _buildLabel(
                                  el.tr(CcLocaleKeys.transaction_payer),
                                ),
                                const CcSpaceXS(),
                                _buildTextField(
        ...
        QuickNumericKeypad(
          ...
          activeColor: const Color(0xFFE54D42),
        ),
      ],
    );
  }
  ...
  Widget _buildSourceDropdown() {
    ...
    final accentColor = const Color(0xFFE54D42);
        ...
        CcInteractBtnWrapper(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: const Color(0xFFE54D42).withOpacity(0.3),
              ),
            ),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                const Icon(Icons.history, color: Color(0xFFE54D42), size: 18),
                const CcSpaceSM(),
                CcText(
