...
/// Entry form for a wallet-to-wallet transfer ("Chuyển khoản") — the third
/// transaction type alongside Chi / Thu. Moves money between wallets without
/// affecting income/expense reports.
class TransferForm extends StatefulWidget {
  /// Called after a transfer is saved (e.g. to refresh totals/history).
  ...
  Future<void> _loadWallets() async {
    ...
    result.when((wallets) {
      setState(() {
        ...
        // Default the destination to a different wallet when possible.
