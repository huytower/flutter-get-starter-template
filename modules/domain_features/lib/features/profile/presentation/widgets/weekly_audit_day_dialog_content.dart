...
class _WeeklyAuditDayDialogContentState
  ...
  Widget _buildDayGrid(BuildContext context, ColorScheme scheme) {
  ...
  Widget _buildDayChip(BuildContext context, ColorScheme scheme, int day) {
