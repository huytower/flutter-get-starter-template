...
/// Repayment/collection method picker on [LoanForm]: installment vs.
...
class LoanRepaymentMethodSection extends StatelessWidget {
  final LoanFormController controller;
  final Color accentColor;

  const LoanRepaymentMethodSection({
    super.key,
