...
class LoanHistorySection extends StatelessWidget {
  final LoanDetailController controller;

  const LoanHistorySection({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        CcFormLabel(text: el.tr(CcLocaleKeys.loan_history_title)),
        const CcSpaceXS(),
        if (controller.history.isEmpty)
          Padding(
            ...
            child: Center(
              child: CcText(
                el.tr(CcLocaleKeys.loan_no_history),
