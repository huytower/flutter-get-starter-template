...
import '../../domain/usecases/loan_balance_calculator.dart';
...
@injectable
class LoanDetailController extends TransactionFormController {
  ...
  final RecordLoanPaymentUseCase _recordLoanPayment;
  ...
  Future<void> load(LoanBalanceEntity balance) async {
    loan.value = balance.loan;
    outstandingBalance.value = balance.outstandingBalance;
    if (_loanId == balance.loan.id) return;
    _loanId = balance.loan.id;
