...
@lazySingleton
class CreateBudgetLimitUseCase {
  CreateBudgetLimitUseCase(this._repository);

  final BudgetLimitRepository _repository;

  Future<Result<BudgetLimitEntity, CcFailure>> call(
    CreateBudgetLimitParams params,
  ) async {
    ...
    final budget = BudgetLimitEntity(
