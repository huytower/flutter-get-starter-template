...
import 'liability_installment_model.dart';
...
class LiabilityModel {
  ...
  @HiveField(10)
  final List<LiabilityInstallmentModel>? installments;

  /// ISO-8601; set iff [repaymentMethod] is [LiabilityRepaymentMethod.lumpSum].
  @HiveField(11)
  ...
  factory LiabilityModel.fromEntity(LiabilityEntity entity) => LiabilityModel(
    ...
    installments: entity.installments
        ?.map(LiabilityInstallmentModel.fromEntity)
        .toList(),
  ...
  LiabilityModel copyWithSyncMetadata(SyncMetadata metadata) {
  ...
  factory LiabilityModel.fromFirestoreData(
