...
class DomainUserEntityConverter implements JsonConverter<DomainUserEntity?, Map<String, dynamic>?> {
  ...
  DomainUserEntity? fromJson(Map<String, dynamic>? json) {
    ...
    return DomainUserEntity(
      ...
      registeredDeviceIds: (json['registeredDeviceIds'] as List<dynamic>?)?.cast<String>() ?? [],
